...
xst -ifn xst.scr
move dcm90_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm90_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm90_exdes.ucf dcm90_exdes

echo 'Running map'
map -timing -pr b dcm90_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dcm90_exdes -w routed.ncd routed.v
cd ..
