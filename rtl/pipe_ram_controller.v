...
`endif
   ...
   assign int_sdram_ready_e = sram_busy[3]/*state == S_SDRAM_RD*/;
   ...
   always @(posedge clk)
     if (reset)
       ...
       begin
	  if (sram_busy[3]/*state == S_SDRAM_RD*/)
	    begin
